    ...
    function getUserInformation() {
        $.ajax({
            ...
            if (res.data.nutrs.length == 0) {
                ...
                var placeholder = {};
                placeholder.Kcal = parseFloat(res.data.nutrs[0].Kcal);
                placeholder.Ballaststoffe = parseFloat(res.data.nutrs[0].Ballaststoffe) / 1000; //transform to g
                placeholder.Calcium = parseFloat(res.data.nutrs[0].Calcium);
                placeholder.Eisen = parseFloat(res.data.nutrs[0].Eisen) / 1000; // transform to mg
                placeholder.Eiweis = parseFloat(res.data.nutrs[0].Eiweis) / 1000; // to g
                placeholder.Fett = parseFloat(res.data.nutrs[0].Fett) / 1000; // to g
                placeholder.Iodid = parseFloat(res.data.nutrs[0].Iodid);
                placeholder.Kalium = parseFloat(res.data.nutrs[0].Kalium);
                placeholder.Kohlenhydrate = parseFloat(res.data.nutrs[0].Kohlenhydrate) / 1000; // to g
                placeholder.Linolsaeure = parseFloat(res.data.nutrs[0].Linolsaeure);
                placeholder.Linolensaeure = parseFloat(res.data.nutrs[0].Linolensaeure);
                placeholder.Magnesium = parseFloat(res.data.nutrs[0].Magnesium);
                placeholder.VitaminA = parseFloat(res.data.nutrs[0].VitaminA) / 1000; // to mg
                placeholder.VitaminB1 = parseFloat(res.data.nutrs[0].VitaminB1) / 1000; // to mg
                placeholder.VitaminB2 = parseFloat(res.data.nutrs[0].VitaminB2) / 1000; // to mg
                placeholder.VitaminB6 = parseFloat(res.data.nutrs[0].VitaminB6) / 1000; // to mg
                placeholder.VitaminB12 = parseFloat(res.data.nutrs[0].VitaminB12);
                placeholder.VitaminC = parseFloat(res.data.nutrs[0].VitaminC) / 1000; // to mg
                placeholder.VitaminE = parseFloat(res.data.nutrs[0].VitaminE) / 1000; // to mg
                placeholder.Zink = parseFloat(res.data.nutrs[0].Zink) / 1000; // to mg
