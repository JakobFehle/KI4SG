        ...
        $.ajax({
            ...
            if (res.data.nutrs.length == 0) {
                ...
                for (var i = 0; i < res.data.nutrs.length; i++) {
                    ...
                    placeholder.Ballaststoffe += parseInt(res.data.nutrs[i].Ballaststoffe);
                    placeholder.Calcium += parseInt(res.data.nutrs[i].Calcium);
                    placeholder.Eisen += parseInt(res.data.nutrs[i].Eisen);
                    placeholder.Eiweis += parseInt(res.data.nutrs[i].Eiweis);
                    placeholder.Fett += parseInt(res.data.nutrs[i].Fett);
                    placeholder.Iodid += parseInt(res.data.nutrs[i].Iodid);
                    placeholder.Kalium += parseInt(res.data.nutrs[i].Kalium);
                    placeholder.Kohlenhydrate += parseInt(res.data.nutrs[i].Kohlenhydrate);
                    ...
                    placeholder.VitaminA += parseInt(res.data.nutrs[i].VitaminA);
                    placeholder.VitaminB1 += parseInt(res.data.nutrs[i].VitaminB1);
                    placeholder.VitaminB2 += parseInt(res.data.nutrs[i].VitaminB2);
                    placeholder.VitaminB6 += parseInt(res.data.nutrs[i].VitaminB6);
                    placeholder.VitaminB12 += parseInt(res.data.nutrs[i].VitaminB12);
                    placeholder.VitaminC += parseInt(res.data.nutrs[i].VitaminC);
                    placeholder.VitaminE += parseInt(res.data.nutrs[i].VitaminE);
                    placeholder.Zink += parseInt(res.data.nutrs[i].Zink);
                }
